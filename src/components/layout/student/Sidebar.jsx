 ...
 */
const getItems = (t) => [
  { to: "/student/dashboard", label: t.dashboard, icon: "grid" },
  { to: "/student/calendar", label: t.calendar, icon: "calendar" },
  { to: "/student/enrollment", label: t.enrollment, icon: "clipboard" },
  { to: "/student/payment", label: t.payments, icon: "card" },
  { to: "/student/historyPayments", label: t.paymentHistory, icon: "card" },
  { to: "/student/profile", label: t.profile, icon: "user" },
];
 ...
 * Iconos disponibles: grid, calendar, clipboard, card, user
 * 
...
function Icon({ name }) {
  ...
  const pathMap = {
    ...
    clipboard:
      "M9 2a1 1 0 0 0 0 2h2a1 1 0 1 0 0-2H9Z M4 5a2 2 0 0 1 2-2 3 3 0 0 0 3 3h2a3 3 0 0 0 3-3 2 2 0 0 1 2 2v15a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V5Zm3 4a1 1 0 0 0 0 2h5a1 1 0 1 0 0-2H7Zm0 4a1 1 0 1 0 0 2h5a1 1 0 1 0 0-2H7Zm0 4a1 1 0 1 0 0 2h5a1 1 0 1 0 0-2H7Z",
    card:
...
export default function Sidebar({ collapsed, onToggleCollapse, onLogout }) {
  ...
  const { lang } = useAuth();
  const t = translations[lang]?.studentSidebar || translations.es.studentSidebar;
