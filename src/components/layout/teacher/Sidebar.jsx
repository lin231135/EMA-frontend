// src/components/layout/teacher/Sidebar.jsx
/**
 * @file Sidebar.jsx (Teacher)
 * @description Barra lateral de navegación para el rol maestro
 * 
 ...
 * - Menú simplificado con opciones específicas para maestros
 * 
...
/**
 * Elementos del menú de navegación para maestros
 * Array estático con rutas, labels e iconos
 * 
 * Opciones específicas para el rol de maestro
 */
const items = [
  { to: "/teacher/dashboard", label: "Dashboard", icon: "grid" },
  { to: "/teacher/calendar", label: "Calendar", icon: "calendar" },
  { to: "/teacher/materials", label: "Materials", icon: "book" },
 ...
 * Iconos disponibles: grid, calendar, book, user
 * 
...
/**
 * Componente principal del Sidebar del maestro
 * 
 * Muestra navegación lateral con menú de opciones para maestros.
 * Incluye:
  ...
  return (
    ...
    >
      ...
      <div className={`flex items-center px-0 py-3 ${collapsed ? "flex-col justify-center" : "flex-row justify-between"}`}>
        {/* Logo con enlace al dashboard del maestro */}
        <Link to="/teacher/dashboard" className="flex items-center justify-start gap-3">
      ...
      {/* Lista de opciones de navegación del maestro */}
      <nav className="px-3">
